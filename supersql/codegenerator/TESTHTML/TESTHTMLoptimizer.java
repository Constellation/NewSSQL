...
public class TESTHTMLoptimizer {
	//created by chie
	//2007-2009

	public TESTHTMLoptimizer() {
	}
		...
		try{
			...
			*/
			...
			if(xml_str.contains("<form")){
				for(int i = 1; i < TESTHTMLEnv.getFormNumber();i++){
					if(xml_str.contains("<form" + i + "start/>")){
						xml_str = xml_str.replace("<form" + i + "start/>",TESTHTMLEnv.getFormDetail(i));
					}
					...
					ch2 != null;ch2 = ch2.getNextSibling()){
						...
						if(childNode.getAttribute("type").equals("connect")){
							if(childNode.hasAttribute("td")){//���ɤ��td������ʤ�
								...
								if(!nowNode.hasAttribute("td")){//nowNode��td���̥�ʤ�
									...
									if(nowNode.getAttribute("type").equals("connect")
											&& nowNode.getAttribute("dimension").equals("2")){//C2�ʤ��
										if(!childNode.getAttribute("tabletype").equals("nest")){
						...
						if(ch2.getNodeName().equals("VALUE") || ch2.getNodeName().equals("EMBED")){
							if(nowNode.hasAttribute("td")){//nowNode��td������
								...
								if(nowNode.getAttribute("type").equals("connect") &&
										nowNode.getAttribute("dimension").equals("1") ){//C1�ʤ�
	...
	public void countTrAndTd(Node n){
		for(Node ch = n.getFirstChild();
			...
			if(ch.getNodeName().equals("VALUE") || ch.getNodeName().equals("EMBED")){//�ͤΤȤ�
				//�ͤΤȤ���tr=1 td=1�Ǥ���
				Element nowNode = (Element) ch;
