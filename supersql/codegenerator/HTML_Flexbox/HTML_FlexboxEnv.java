...
public class HTML_FlexboxEnv extends LocalEnv {
	...
	public static String getClassID(ITFE tfe) {
		String result;
		if (tfe instanceof HTML_FlexboxC3) {
			result = getClassID(((ITFE) ((HTML_FlexboxC3) tfe).tfes.get(0)));
			return result;
		}
		if (tfe instanceof HTML_FlexboxG3) {
			result = getClassID(((ITFE) ((HTML_FlexboxG3) tfe).tfe));
			return result;
		}
	...
	public static String getDataID(ITFE tfe) {
		...
		if (tfe instanceof HTML_FlexboxC3) {
			return getClassID(((ITFE) ((HTML_FlexboxC3) tfe).tfes.get(0)));
		}
		if (tfe instanceof HTML_FlexboxG3) {
			return getClassID(((ITFE) ((HTML_FlexboxG3) tfe).tfe));
		}
