...
public class HTML_FlexboxC1 extends Connector {

	/** @deprecated use HTMLC2() instead **/
	@Deprecated
    public HTML_FlexboxC1(Manager manager, HTML_FlexboxEnv henv, HTML_FlexboxEnv henv2) {
        Dimension = 1;
    }
	
	public HTML_FlexboxC1(){
		Dimension = 1;
	}
    ...
    public Element createTableNode(ExtList<ExtList<String>> dataInfo){
    	...
    	while(this.hasMoreItems()){
            ...
            result.addClass(HTML_FlexboxEnv.getClassID(tfe));
